...
_HWHP_EXTRA_PROPS = [
    ...
    HWHP_PROP_WSTATE,
    HWHP_PROP_POW_CONSUMP,
    # Nasze natywne dopiski dla klimatyzacji:
    "OutEnvTem", "EnvTem", "CompressorTem", "InEvaTem", "CompressorFqy",
    "ElcAllConsumption", "PM2P5", "UvcControl", "SwUpDn", "SwingLfRig",
    "ChildLock", "AntiDirectBlow", "SvSt", "AutoCleanSta", "Dazzling", "ElcAll"
]
